...
// NavRenderCursorFlags_ImGuiNavHighlightFlags_None :: NavRenderCursorFlags{.None} // Renamed in 1.91.4
...
DebugLogFlag :: enum c.int {
	...
	EventFont          = 8,
	EventInputRouting  = 9,
	EventDocking       = 10, // Unused in this branch
	EventViewport      = 11, // Unused in this branch
	OutputToTTY        = 20, // Also send output to TTY
	OutputToTestEngine = 21, // Also send output to Test Engine
}

DebugLogFlags_EventMask_ :: DebugLogFlags {
	.EventError,
	.EventActiveId,
	.EventFocus,
	.EventPopup,
...
Vector_TreeNodeStackData :: struct {
...
Vector_TableInstanceData :: struct {
...
Vector_TableColumnSortSpecs :: struct {
...
Vector_MultiSelectTempData :: struct {
...
Vector_MultiSelectState :: struct {
...
Vector_ListClipperRange :: struct {
...
Context :: struct {
	...
	// CurrentDpiScale:                    f32, // Current window/viewport DpiScale
	...
	// // Viewports
	// Viewports:                          Vector_ViewportPPtr, // Active viewports (Size==1 in 'master' branch). Each viewports hold their copy of ImDrawData.
...
foreign lib {
	// Helpers: Hashing
	@(link_name = "cImHashData")
	cImHashData :: proc(data: rawptr, data_size: c.size_t, seed: ID = {}) -> ID ---
	@(link_name = "cImHashStr")
	cImHashStr :: proc(data: cstring, data_size: c.size_t = {}, seed: ID = {}) -> ID ---
	// Helpers: Color Blending
	@(link_name = "cImAlphaBlendColors")
	cImAlphaBlendColors :: proc(col_a: u32, col_b: u32) -> u32 ---
	// Helpers: Bit manipulation
	@(link_name = "cImIsPowerOfTwo")
	cImIsPowerOfTwo :: proc(v: c.int) -> bool ---
	@(link_name = "cImIsPowerOfTwoImU64")
	cImIsPowerOfTwoImU64 :: proc(v: u64) -> bool ---
	@(link_name = "cImUpperPowerOfTwo")
	cImUpperPowerOfTwo :: proc(v: c.int) -> c.int ---
	@(link_name = "cImCountSetBits")
	cImCountSetBits :: proc(v: c.uint) -> c.uint ---
	@(link_name = "cImStricmp")
	cImStricmp :: proc(str1: cstring, str2: cstring) -> c.int --- // Case insensitive compare.
	@(link_name = "cImStrnicmp")
	cImStrnicmp :: proc(str1: cstring, str2: cstring, count: c.size_t) -> c.int --- // Case insensitive compare to a certain count.
	@(link_name = "cImStrncpy")
	...
	@(link_name = "cImStrdupcpy")
	cImStrdupcpy :: proc(dst: cstring, p_dst_size: ^c.size_t, str: cstring) -> cstring --- // Copy in provided buffer, recreate buffer if needed.
	@(link_name = "cImStrchrRange")
	cImStrchrRange :: proc(str_begin: cstring, str_end: cstring, _c: c.char) -> cstring --- // Find first occurrence of 'c' in string range.
	@(link_name = "cImStreolRange")
	cImStreolRange :: proc(str: cstring, str_end: cstring) -> cstring --- // End end-of-line
	@(link_name = "cImStristr")
	...
	@(link_name = "cImStrTrimBlanks")
	cImStrTrimBlanks :: proc(str: cstring) --- // Remove leading and trailing blanks from a buffer.
	@(link_name = "cImStrSkipBlank")
	cImStrSkipBlank :: proc(str: cstring) -> cstring --- // Find first non-blank character.
	@(link_name = "cImStrlenW")
	cImStrlenW :: proc(str: ^Wchar) -> c.int --- // Computer string length (ImWchar string)
	@(link_name = "cImStrbol")
	cImStrbol :: proc(buf_mid_line: cstring, buf_begin: cstring) -> cstring --- // Find beginning-of-line
	@(link_name = "cImToUpper")
	cImToUpper :: proc(_c: c.char) -> c.char ---
	@(link_name = "cImCharIsBlankA")
	cImCharIsBlankA :: proc(_c: c.char) -> bool ---
	@(link_name = "cImCharIsBlankW")
	cImCharIsBlankW :: proc(_c: c.uint) -> bool ---
	@(link_name = "cImCharIsXdigitA")
	cImCharIsXdigitA :: proc(_c: c.char) -> bool ---
	// Helpers: Formatting
	@(link_name = "cImFormatString")
	cImFormatString :: proc(buf: cstring, buf_size: c.size_t, fmt: cstring, #c_vararg args: ..any) -> c.int ---
	@(link_name = "cImFormatStringToTempBuffer")
	cImFormatStringToTempBuffer :: proc(out_buf: ^cstring, out_buf_end: ^cstring, fmt: cstring, #c_vararg args: ..any) ---
	@(link_name = "cImParseFormatFindStart")
	cImParseFormatFindStart :: proc(format: cstring) -> cstring ---
	@(link_name = "cImParseFormatFindEnd")
	cImParseFormatFindEnd :: proc(format: cstring) -> cstring ---
	@(link_name = "cImParseFormatTrimDecorations")
	cImParseFormatTrimDecorations :: proc(format: cstring, buf: cstring, buf_size: c.size_t) -> cstring ---
	@(link_name = "cImParseFormatSanitizeForPrinting")
	cImParseFormatSanitizeForPrinting :: proc(fmt_in: cstring, fmt_out: cstring, fmt_out_size: c.size_t) ---
	@(link_name = "cImParseFormatSanitizeForScanning")
	cImParseFormatSanitizeForScanning :: proc(fmt_in: cstring, fmt_out: cstring, fmt_out_size: c.size_t) -> cstring ---
	@(link_name = "cImParseFormatPrecision")
	cImParseFormatPrecision :: proc(format: cstring, default_value: c.int) -> c.int ---
	// Helpers: UTF-8 <> wchar conversions
	@(link_name = "cImTextCharToUtf8")
	cImTextCharToUtf8 :: proc(out_buf: ^[5]c.char, _c: c.uint) -> cstring --- // return out_buf
	@(link_name = "cImTextStrToUtf8")
	cImTextStrToUtf8 :: proc(out_buf: cstring, out_buf_size: c.int, in_text: ^Wchar, in_text_end: ^Wchar) -> c.int --- // return output UTF-8 bytes count
	@(link_name = "cImTextCharFromUtf8")
	cImTextCharFromUtf8 :: proc(out_char: ^c.uint, in_text: cstring, in_text_end: cstring) -> c.int --- // read one character. return input UTF-8 bytes count
	@(link_name = "cImTextStrFromUtf8")
	cImTextStrFromUtf8 :: proc(out_buf: ^Wchar, out_buf_size: c.int, in_text: cstring, in_text_end: cstring, in_remaining: ^cstring = nil) -> c.int --- // return input UTF-8 bytes count
	@(link_name = "cImTextCountCharsFromUtf8")
	cImTextCountCharsFromUtf8 :: proc(in_text: cstring, in_text_end: cstring) -> c.int --- // return number of UTF-8 code-points (NOT bytes count)
	@(link_name = "cImTextCountUtf8BytesFromChar")
	cImTextCountUtf8BytesFromChar :: proc(in_text: cstring, in_text_end: cstring) -> c.int --- // return number of bytes to express one char in UTF-8
	@(link_name = "cImTextCountUtf8BytesFromStr")
	cImTextCountUtf8BytesFromStr :: proc(in_text: ^Wchar, in_text_end: ^Wchar) -> c.int --- // return number of bytes to express string in UTF-8
	@(link_name = "cImTextFindPreviousUtf8Codepoint")
	cImTextFindPreviousUtf8Codepoint :: proc(in_text_start: cstring, in_text_curr: cstring) -> cstring --- // return previous UTF-8 code-point.
	@(link_name = "cImTextCountLines")
	cImTextCountLines :: proc(in_text: cstring, in_text_end: cstring) -> c.int --- // return number of lines taken by text. trailing carriage return doesn't count as an extra line.
	@(link_name = "cImFileOpen")
	cImFileOpen :: proc(filename: cstring, mode: cstring) -> FileHandle ---
	@(link_name = "cImFileClose")
	cImFileClose :: proc(file: FileHandle) -> bool ---
	@(link_name = "cImFileGetSize")
	cImFileGetSize :: proc(file: FileHandle) -> u64 ---
	@(link_name = "cImFileRead")
	cImFileRead :: proc(data: rawptr, size: u64, count: u64, file: FileHandle) -> u64 ---
	@(link_name = "cImFileWrite")
	cImFileWrite :: proc(data: rawptr, size: u64, count: u64, file: FileHandle) -> u64 ---
	@(link_name = "cImFileLoadToMemory")
	cImFileLoadToMemory :: proc(filename: cstring, mode: cstring, out_file_size: ^c.size_t = nil, padding_bytes: c.int = {}) -> rawptr ---
	@(link_name = "cImPow")
	cImPow :: proc(x: f32, y: f32) -> f32 --- // DragBehaviorT/SliderBehaviorT uses ImPow with either float/double and need the precision
	@(link_name = "cImPowDouble")
	...
	@(link_name = "ImRect_Contains")
	Rect_Contains :: proc(self: ^Rect, p: Vec2) -> bool ---
	@(link_name = "ImRect_ContainsImRect")
	Rect_ContainsImRect :: proc(self: ^Rect, r: Rect) -> bool ---
	@(link_name = "ImRect_ContainsWithPad")
	...
	@(link_name = "cImBitArrayGetStorageSizeInBytes")
	cImBitArrayGetStorageSizeInBytes :: proc(bitcount: c.int) -> c.size_t ---
	@(link_name = "cImBitArrayClearAllBits")
	cImBitArrayClearAllBits :: proc(arr: ^u32, bitcount: c.int) ---
	@(link_name = "cImBitArrayTestBit")
	cImBitArrayTestBit :: proc(arr: ^u32, n: c.int) -> bool ---
	@(link_name = "cImBitArrayClearBit")
	cImBitArrayClearBit :: proc(arr: ^u32, n: c.int) ---
	@(link_name = "cImBitArraySetBit")
	cImBitArraySetBit :: proc(arr: ^u32, n: c.int) ---
	@(link_name = "cImBitArraySetBitRange")
	cImBitArraySetBitRange :: proc(arr: ^u32, n: c.int, n2: c.int) --- // Works on range [n..n2)
	@(link_name = "ImBitVector_Create")
	BitVector_Create :: proc(self: ^BitVector, sz: c.int) ---
	@(link_name = "ImBitVector_Clear")
	BitVector_Clear :: proc(self: ^BitVector) ---
	@(link_name = "ImBitVector_TestBit")
	BitVector_TestBit :: proc(self: ^BitVector, n: c.int) -> bool ---
	@(link_name = "ImBitVector_SetBit")
	BitVector_SetBit :: proc(self: ^BitVector, n: c.int) ---
	@(link_name = "ImBitVector_ClearBit")
	BitVector_ClearBit :: proc(self: ^BitVector, n: c.int) ---
	@(link_name = "ImGuiTextIndex_clear")
	TextIndex_clear :: proc(self: ^TextIndex) ---
	@(link_name = "ImGuiTextIndex_size")
	TextIndex_size :: proc(self: ^TextIndex) -> c.int ---
	@(link_name = "ImGuiTextIndex_get_line_begin")
	TextIndex_get_line_begin :: proc(self: ^TextIndex, base: cstring, n: c.int) -> cstring ---
	@(link_name = "ImGuiTextIndex_get_line_end")
	TextIndex_get_line_end :: proc(self: ^TextIndex, base: cstring, n: c.int) -> cstring ---
	@(link_name = "ImGuiTextIndex_append")
	TextIndex_append :: proc(self: ^TextIndex, base: cstring, old_size: c.int, new_size: c.int) ---
	// Helper: ImGuiStorage
	@(link_name = "cImLowerBound")
	cImLowerBound :: proc(in_begin: ^StoragePair, in_end: ^StoragePair, key: ID) -> ^StoragePair ---
	...
	@(link_name = "ImGuiStyleVarInfo_GetVarPtr")
	StyleVarInfo_GetVarPtr :: proc(self: ^StyleVarInfo, parent: rawptr) -> rawptr ---
	@(link_name = "ImGuiMenuColumns_Update")
	MenuColumns_Update :: proc(self: ^MenuColumns, spacing: f32, window_reappearing: bool) ---
	@(link_name = "ImGuiMenuColumns_DeclColumns")
	MenuColumns_DeclColumns :: proc(self: ^MenuColumns, w_icon: f32, w_label: f32, w_shortcut: f32, w_mark: f32) -> f32 ---
	@(link_name = "ImGuiMenuColumns_CalcNextTotalWidth")
	MenuColumns_CalcNextTotalWidth :: proc(self: ^MenuColumns, update_offsets: bool) ---
	@(link_name = "ImGuiInputTextDeactivatedState_ClearFreeMemory")
	InputTextDeactivatedState_ClearFreeMemory :: proc(self: ^InputTextDeactivatedState) ---
	@(link_name = "ImGuiInputTextState_ClearText")
	InputTextState_ClearText :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_ClearFreeMemory")
	InputTextState_ClearFreeMemory :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_OnKeyPressed")
	InputTextState_OnKeyPressed :: proc(self: ^InputTextState, key: c.int) --- // Cannot be inline because we call in code in stb_textedit.h implementation
	@(link_name = "ImGuiInputTextState_OnCharPressed")
	InputTextState_OnCharPressed :: proc(self: ^InputTextState, _c: c.uint) ---
	// Cursor & Selection
	@(link_name = "ImGuiInputTextState_CursorAnimReset")
	InputTextState_CursorAnimReset :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_CursorClamp")
	InputTextState_CursorClamp :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_HasSelection")
	InputTextState_HasSelection :: proc(self: ^InputTextState) -> bool ---
	@(link_name = "ImGuiInputTextState_ClearSelection")
	InputTextState_ClearSelection :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_GetCursorPos")
	InputTextState_GetCursorPos :: proc(self: ^InputTextState) -> c.int ---
	@(link_name = "ImGuiInputTextState_GetSelectionStart")
	InputTextState_GetSelectionStart :: proc(self: ^InputTextState) -> c.int ---
	@(link_name = "ImGuiInputTextState_GetSelectionEnd")
	InputTextState_GetSelectionEnd :: proc(self: ^InputTextState) -> c.int ---
	@(link_name = "ImGuiInputTextState_SelectAll")
	InputTextState_SelectAll :: proc(self: ^InputTextState) ---
	// Reload user buf (WIP #2890)
	// If you modify underlying user-passed const char* while active you need to call this (InputText V2 may lift this)
	//   strcpy(my_buf, "hello");
	//   if (ImGuiInputTextState* state = ImGui::GetInputTextState(id)) // id may be ImGui::GetItemID() is last item
	//       state->ReloadUserBufAndSelectAll();
	@(link_name = "ImGuiInputTextState_ReloadUserBufAndSelectAll")
	InputTextState_ReloadUserBufAndSelectAll :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_ReloadUserBufAndKeepSelection")
	InputTextState_ReloadUserBufAndKeepSelection :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiInputTextState_ReloadUserBufAndMoveToEnd")
	InputTextState_ReloadUserBufAndMoveToEnd :: proc(self: ^InputTextState) ---
	@(link_name = "ImGuiNextWindowData_ClearFlags")
	NextWindowData_ClearFlags :: proc(self: ^NextWindowData) ---
	@(link_name = "ImGuiNextItemData_ClearFlags")
	NextItemData_ClearFlags :: proc(self: ^NextItemData) --- // Also cleared manually by ItemAdd()!
	@(link_name = "ImGuiKeyRoutingTable_Clear")
	KeyRoutingTable_Clear :: proc(self: ^KeyRoutingTable) ---
	@(link_name = "ImGuiListClipperRange_FromIndices")
	ListClipperRange_FromIndices :: proc(min: c.int, max: c.int) -> ListClipperRange ---
	@(link_name = "ImGuiListClipperRange_FromPositions")
	ListClipperRange_FromPositions :: proc(y1: f32, y2: f32, off_min: c.int, off_max: c.int) -> ListClipperRange ---
	@(link_name = "ImGuiListClipperData_Reset")
	ListClipperData_Reset :: proc(self: ^ListClipperData, clipper: ^ListClipper) ---
	@(link_name = "ImGuiNavItemData_Clear")
	NavItemData_Clear :: proc(self: ^NavItemData) ---
	@(link_name = "ImGuiTypingSelectState_Clear")
	TypingSelectState_Clear :: proc(self: ^TypingSelectState) --- // We preserve remaining data for easier debugging
	@(link_name = "ImGuiMultiSelectTempData_Clear")
	MultiSelectTempData_Clear :: proc(self: ^MultiSelectTempData) --- // Zero-clear except IO as we preserve IO.Requests[] buffer allocation.
	@(link_name = "ImGuiMultiSelectTempData_ClearIO")
	MultiSelectTempData_ClearIO :: proc(self: ^MultiSelectTempData) ---
	// Calculate work rect pos/size given a set of offset (we have 1 pair of offset for rect locked from last frame data, and 1 pair for currently building rect)
	@(link_name = "ImGuiViewportP_CalcWorkRectPos")
	ViewportP_CalcWorkRectPos :: proc(self: ^ViewportP, inset_min: Vec2) -> Vec2 ---
	@(link_name = "ImGuiViewportP_CalcWorkRectSize")
	ViewportP_CalcWorkRectSize :: proc(self: ^ViewportP, inset_min: Vec2, inset_max: Vec2) -> Vec2 ---
	@(link_name = "ImGuiViewportP_UpdateWorkRect")
	ViewportP_UpdateWorkRect :: proc(self: ^ViewportP) --- // Update public fields
	// Helpers to retrieve ImRect (we don't need to store BuildWorkRect as every access tend to change it, hence the code asymmetry)
	@(link_name = "ImGuiViewportP_GetMainRect")
	ViewportP_GetMainRect :: proc(self: ^ViewportP) -> Rect ---
	@(link_name = "ImGuiViewportP_GetWorkRect")
	ViewportP_GetWorkRect :: proc(self: ^ViewportP) -> Rect ---
	@(link_name = "ImGuiViewportP_GetBuildWorkRect")
	ViewportP_GetBuildWorkRect :: proc(self: ^ViewportP) -> Rect ---
	@(link_name = "ImGuiWindowSettings_GetName")
	WindowSettings_GetName :: proc(self: ^WindowSettings) -> cstring ---
	@(link_name = "ImGuiWindow_GetIDStr")
	Window_GetIDStr :: proc(self: ^Window, str: cstring, str_end: cstring = nil) -> ID ---
	@(link_name = "ImGuiWindow_GetID")
	Window_GetID :: proc(self: ^Window, ptr: rawptr) -> ID ---
	@(link_name = "ImGuiWindow_GetIDInt")
	Window_GetIDInt :: proc(self: ^Window, n: c.int) -> ID ---
	@(link_name = "ImGuiWindow_GetIDFromPos")
	Window_GetIDFromPos :: proc(self: ^Window, p_abs: Vec2) -> ID ---
	...
	Window_Rect :: proc(self: ^Window) -> Rect ---
	@(link_name = "ImGuiWindow_CalcFontSize")
	Window_CalcFontSize :: proc(self: ^Window) -> f32 ---
	@(link_name = "ImGuiWindow_TitleBarRect")
	Window_TitleBarRect :: proc(self: ^Window) -> Rect ---
	@(link_name = "ImGuiWindow_MenuBarRect")
	Window_MenuBarRect :: proc(self: ^Window) -> Rect ---
	@(link_name = "ImGuiTableSettings_GetColumnSettings")
	TableSettings_GetColumnSettings :: proc(self: ^TableSettings) -> ^TableColumnSettings ---
	// Windows
	// We should always have a CurrentWindow in the stack (there is an implicit "Debug" window)
	// If this ever crashes because g.CurrentWindow is NULL, it means that either:
	// - ImGui::NewFrame() has never been called, which is illegal.
	// - You are calling ImGui functions after ImGui::EndFrame()/ImGui::Render() and before the next ImGui::NewFrame(), which is also illegal.
	@(link_name = "ImGui_GetIOImGuiContextPtr")
	GetIOImGuiContextPtr :: proc(ctx: ^Context) -> ^IO ---
	@(link_name = "ImGui_GetPlatformIOImGuiContextPtr")
	GetPlatformIOImGuiContextPtr :: proc(ctx: ^Context) -> ^PlatformIO ---
	@(link_name = "ImGui_GetCurrentWindowRead")
	GetCurrentWindowRead :: proc() -> ^Window ---
	@(link_name = "ImGui_GetCurrentWindow")
	GetCurrentWindow :: proc() -> ^Window ---
	@(link_name = "ImGui_FindWindowByID")
	FindWindowByID :: proc(id: ID) -> ^Window ---
	@(link_name = "ImGui_FindWindowByName")
	FindWindowByName :: proc(name: cstring) -> ^Window ---
	@(link_name = "ImGui_UpdateWindowParentAndRootLinks")
	UpdateWindowParentAndRootLinks :: proc(window: ^Window, flags: WindowFlags, parent_window: ^Window) ---
	@(link_name = "ImGui_UpdateWindowSkipRefresh")
	UpdateWindowSkipRefresh :: proc(window: ^Window) ---
	@(link_name = "ImGui_CalcWindowNextAutoFitSize")
	CalcWindowNextAutoFitSize :: proc(window: ^Window) -> Vec2 ---
	@(link_name = "ImGui_IsWindowChildOf")
	IsWindowChildOf :: proc(window: ^Window, potential_parent: ^Window, popup_hierarchy: bool) -> bool ---
	@(link_name = "ImGui_IsWindowWithinBeginStackOf")
	IsWindowWithinBeginStackOf :: proc(window: ^Window, potential_parent: ^Window) -> bool ---
	@(link_name = "ImGui_IsWindowAbove")
	IsWindowAbove :: proc(potential_above: ^Window, potential_below: ^Window) -> bool ---
	@(link_name = "ImGui_IsWindowNavFocusable")
	IsWindowNavFocusable :: proc(window: ^Window) -> bool ---
	@(link_name = "ImGui_SetWindowPosImGuiWindowPtr")
	SetWindowPosImGuiWindowPtr :: proc(window: ^Window, pos: Vec2, cond: Cond = {}) ---
	@(link_name = "ImGui_SetWindowSizeImGuiWindowPtr")
	SetWindowSizeImGuiWindowPtr :: proc(window: ^Window, size: Vec2, cond: Cond = {}) ---
	@(link_name = "ImGui_SetWindowCollapsedImGuiWindowPtr")
	SetWindowCollapsedImGuiWindowPtr :: proc(window: ^Window, collapsed: bool, cond: Cond = {}) ---
	@(link_name = "ImGui_SetWindowHitTestHole")
	SetWindowHitTestHole :: proc(window: ^Window, pos: Vec2, size: Vec2) ---
	@(link_name = "ImGui_SetWindowHiddenAndSkipItemsForCurrentFrame")
	SetWindowHiddenAndSkipItemsForCurrentFrame :: proc(window: ^Window) ---
	@(link_name = "ImGui_SetWindowParentWindowForFocusRoute")
	SetWindowParentWindowForFocusRoute :: proc(window: ^Window, parent_window: ^Window) ---
	@(link_name = "ImGui_WindowRectAbsToRel")
	WindowRectAbsToRel :: proc(window: ^Window, r: Rect) -> Rect ---
	@(link_name = "ImGui_WindowRectRelToAbs")
	WindowRectRelToAbs :: proc(window: ^Window, r: Rect) -> Rect ---
	@(link_name = "ImGui_WindowPosAbsToRel")
	WindowPosAbsToRel :: proc(window: ^Window, p: Vec2) -> Vec2 ---
	@(link_name = "ImGui_WindowPosRelToAbs")
	WindowPosRelToAbs :: proc(window: ^Window, p: Vec2) -> Vec2 ---
	// Windows: Display Order and Focus Order
	@(link_name = "ImGui_FocusWindow")
	FocusWindow :: proc(window: ^Window, flags: FocusRequestFlags = {}) ---
	@(link_name = "ImGui_FocusTopMostWindowUnderOne")
	FocusTopMostWindowUnderOne :: proc(under_this_window: ^Window, ignore_window: ^Window, filter_viewport: ^Viewport, flags: FocusRequestFlags) ---
	@(link_name = "ImGui_BringWindowToFocusFront")
	BringWindowToFocusFront :: proc(window: ^Window) ---
	@(link_name = "ImGui_BringWindowToDisplayFront")
	BringWindowToDisplayFront :: proc(window: ^Window) ---
	@(link_name = "ImGui_BringWindowToDisplayBack")
	BringWindowToDisplayBack :: proc(window: ^Window) ---
	@(link_name = "ImGui_BringWindowToDisplayBehind")
	BringWindowToDisplayBehind :: proc(window: ^Window, above_window: ^Window) ---
	@(link_name = "ImGui_FindWindowDisplayIndex")
	FindWindowDisplayIndex :: proc(window: ^Window) -> c.int ---
	@(link_name = "ImGui_FindBottomMostVisibleWindowWithinBeginStack")
	FindBottomMostVisibleWindowWithinBeginStack :: proc(window: ^Window) -> ^Window ---
	// Windows: Idle, Refresh Policies [EXPERIMENTAL]
	@(link_name = "ImGui_SetNextWindowRefreshPolicy")
	SetNextWindowRefreshPolicy :: proc(flags: WindowRefreshFlags) ---
	// Fonts, drawing
	@(link_name = "ImGui_SetCurrentFont")
	SetCurrentFont :: proc(font: ^Font) ---
	@(link_name = "ImGui_GetDefaultFont")
	GetDefaultFont :: proc() -> ^Font ---
	@(link_name = "ImGui_PushPasswordFont")
	PushPasswordFont :: proc() ---
	@(link_name = "ImGui_GetForegroundDrawListImGuiWindowPtr")
	GetForegroundDrawListImGuiWindowPtr :: proc(window: ^Window) -> ^DrawList --- // This seemingly unnecessary wrapper simplifies compatibility between the 'master' and 'docking' branches.
	@(link_name = "ImGui_GetBackgroundDrawListImGuiViewportPtr")
	GetBackgroundDrawListImGuiViewportPtr :: proc(viewport: ^Viewport) -> ^DrawList --- // get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear imgui contents.
	@(link_name = "ImGui_GetForegroundDrawListImGuiViewportPtr")
	GetForegroundDrawListImGuiViewportPtr :: proc(viewport: ^Viewport) -> ^DrawList --- // get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents.
	@(link_name = "ImGui_AddDrawListToDrawDataEx")
	AddDrawListToDrawDataEx :: proc(draw_data: ^DrawData, out_list: ^Vector_DrawListPtr, draw_list: ^DrawList) ---
	// Init
	@(link_name = "ImGui_Initialize")
	Initialize :: proc() ---
	@(link_name = "ImGui_Shutdown")
	Shutdown :: proc() --- // Since 1.60 this is a _private_ function. You can call DestroyContext() to destroy the context created by CreateContext().
	// NewFrame
	@(link_name = "ImGui_UpdateInputEvents")
	UpdateInputEvents :: proc(trickle_fast_inputs: bool) ---
	@(link_name = "ImGui_UpdateHoveredWindowAndCaptureFlags")
	UpdateHoveredWindowAndCaptureFlags :: proc() ---
	@(link_name = "ImGui_FindHoveredWindowEx")
	FindHoveredWindowEx :: proc(pos: Vec2, find_first_and_in_any_viewport: bool, out_hovered_window: ^^Window, out_hovered_window_under_moving_window: ^^Window) ---
	@(link_name = "ImGui_StartMouseMovingWindow")
	StartMouseMovingWindow :: proc(window: ^Window) ---
	@(link_name = "ImGui_UpdateMouseMovingWindowNewFrame")
	UpdateMouseMovingWindowNewFrame :: proc() ---
	@(link_name = "ImGui_UpdateMouseMovingWindowEndFrame")
	UpdateMouseMovingWindowEndFrame :: proc() ---
	// Generic context hooks
	@(link_name = "ImGui_AddContextHook")
	AddContextHook :: proc(_context: ^Context, hook: ^ContextHook) -> ID ---
	@(link_name = "ImGui_RemoveContextHook")
	RemoveContextHook :: proc(_context: ^Context, hook_to_remove: ID) ---
	@(link_name = "ImGui_CallContextHooks")
	CallContextHooks :: proc(_context: ^Context, type: ContextHookType) ---
	// Viewports
	@(link_name = "ImGui_ScaleWindowsInViewport")
	ScaleWindowsInViewport :: proc(viewport: ^ViewportP, scale: f32) ---
	@(link_name = "ImGui_SetWindowViewport")
	SetWindowViewport :: proc(window: ^Window, viewport: ^ViewportP) ---
	// Settings
	@(link_name = "ImGui_MarkIniSettingsDirty")
	MarkIniSettingsDirty :: proc() ---
	@(link_name = "ImGui_MarkIniSettingsDirtyImGuiWindowPtr")
	MarkIniSettingsDirtyImGuiWindowPtr :: proc(window: ^Window) ---
	@(link_name = "ImGui_ClearIniSettings")
	ClearIniSettings :: proc() ---
	@(link_name = "ImGui_AddSettingsHandler")
	AddSettingsHandler :: proc(handler: ^SettingsHandler) ---
	@(link_name = "ImGui_RemoveSettingsHandler")
	RemoveSettingsHandler :: proc(type_name: cstring) ---
	@(link_name = "ImGui_FindSettingsHandler")
	FindSettingsHandler :: proc(type_name: cstring) -> ^SettingsHandler ---
	// Settings - Windows
	@(link_name = "ImGui_CreateNewWindowSettings")
	CreateNewWindowSettings :: proc(name: cstring) -> ^WindowSettings ---
	@(link_name = "ImGui_FindWindowSettingsByID")
	FindWindowSettingsByID :: proc(id: ID) -> ^WindowSettings ---
	@(link_name = "ImGui_FindWindowSettingsByWindow")
	FindWindowSettingsByWindow :: proc(window: ^Window) -> ^WindowSettings ---
	@(link_name = "ImGui_ClearWindowSettings")
	ClearWindowSettings :: proc(name: cstring) ---
	// Localization
	@(link_name = "ImGui_LocalizeRegisterEntries")
	LocalizeRegisterEntries :: proc(entries: ^LocEntry, count: c.int) ---
	@(link_name = "ImGui_LocalizeGetMsg")
	LocalizeGetMsg :: proc(key: LocKey) -> cstring ---
	// Scrolling
	@(link_name = "ImGui_SetScrollXImGuiWindowPtr")
	SetScrollXImGuiWindowPtr :: proc(window: ^Window, scroll_x: f32) ---
	@(link_name = "ImGui_SetScrollYImGuiWindowPtr")
	SetScrollYImGuiWindowPtr :: proc(window: ^Window, scroll_y: f32) ---
	@(link_name = "ImGui_SetScrollFromPosXImGuiWindowPtr")
	SetScrollFromPosXImGuiWindowPtr :: proc(window: ^Window, local_x: f32, center_x_ratio: f32) ---
	@(link_name = "ImGui_SetScrollFromPosYImGuiWindowPtr")
	SetScrollFromPosYImGuiWindowPtr :: proc(window: ^Window, local_y: f32, center_y_ratio: f32) ---
	// Early work-in-progress API (ScrollToItem() will become public)
	@(link_name = "ImGui_ScrollToItem")
	ScrollToItem :: proc(flags: ScrollFlags = {}) ---
	@(link_name = "ImGui_ScrollToRect")
	ScrollToRect :: proc(window: ^Window, rect: Rect, flags: ScrollFlags = {}) ---
	@(link_name = "ImGui_ScrollToRectEx")
	ScrollToRectEx :: proc(window: ^Window, rect: Rect, flags: ScrollFlags = {}) -> Vec2 ---
	//#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
	@(link_name = "ImGui_ScrollToBringRectIntoView")
	ScrollToBringRectIntoView :: proc(window: ^Window, rect: Rect) ---
	// Basic Accessors
	@(link_name = "ImGui_GetItemStatusFlags")
	GetItemStatusFlags :: proc() -> ItemStatusFlags ---
	@(link_name = "ImGui_GetItemFlags")
	GetItemFlags :: proc() -> ItemFlags ---
	@(link_name = "ImGui_GetActiveID")
	GetActiveID :: proc() -> ID ---
	@(link_name = "ImGui_GetFocusID")
	GetFocusID :: proc() -> ID ---
	@(link_name = "ImGui_SetActiveID")
	SetActiveID :: proc(id: ID, window: ^Window) ---
	@(link_name = "ImGui_SetFocusID")
	SetFocusID :: proc(id: ID, window: ^Window) ---
	@(link_name = "ImGui_ClearActiveID")
	ClearActiveID :: proc() ---
	@(link_name = "ImGui_GetHoveredID")
	GetHoveredID :: proc() -> ID ---
	@(link_name = "ImGui_SetHoveredID")
	SetHoveredID :: proc(id: ID) ---
	@(link_name = "ImGui_KeepAliveID")
	KeepAliveID :: proc(id: ID) ---
	@(link_name = "ImGui_MarkItemEdited")
	MarkItemEdited :: proc(id: ID) --- // Mark data associated to given item as "edited", used by IsItemDeactivatedAfterEdit() function.
	@(link_name = "ImGui_PushOverrideID")
	PushOverrideID :: proc(id: ID) --- // Push given value as-is at the top of the ID stack (whereas PushID combines old and new hashes)
	@(link_name = "ImGui_GetIDWithSeedStr")
	GetIDWithSeedStr :: proc(str_id_begin: cstring, str_id_end: cstring, seed: ID) -> ID ---
	@(link_name = "ImGui_GetIDWithSeed")
	GetIDWithSeed :: proc(n: c.int, seed: ID) -> ID ---
	// Basic Helpers for widget code
	@(link_name = "ImGui_ItemSize")
	ItemSize :: proc(size: Vec2, text_baseline_y: f32 = -1.0) ---
	@(link_name = "ImGui_ItemSizeImRect")
	ItemSizeImRect :: proc(bb: Rect, text_baseline_y: f32 = -1.0) --- // FIXME: This is a misleading API since we expect CursorPos to be bb.Min.
	@(link_name = "ImGui_ItemAdd")
	ItemAdd :: proc(bb: Rect, id: ID, nav_bb: ^Rect = nil, extra_flags: ItemFlags = {}) -> bool ---
	@(link_name = "ImGui_ItemHoverable")
	ItemHoverable :: proc(bb: Rect, id: ID, item_flags: ItemFlags) -> bool ---
	@(link_name = "ImGui_IsWindowContentHoverable")
	IsWindowContentHoverable :: proc(window: ^Window, flags: HoveredFlags = {}) -> bool ---
	@(link_name = "ImGui_IsClippedEx")
	IsClippedEx :: proc(bb: Rect, id: ID) -> bool ---
	@(link_name = "ImGui_SetLastItemData")
	SetLastItemData :: proc(item_id: ID, item_flags: ItemFlags, status_flags: ItemStatusFlags, item_rect: Rect) ---
	@(link_name = "ImGui_CalcItemSize")
	CalcItemSize :: proc(size: Vec2, default_w: f32, default_h: f32) -> Vec2 ---
	@(link_name = "ImGui_CalcWrapWidthForPos")
	CalcWrapWidthForPos :: proc(pos: Vec2, wrap_pos_x: f32) -> f32 ---
	@(link_name = "ImGui_PushMultiItemsWidths")
	PushMultiItemsWidths :: proc(components: c.int, width_full: f32) ---
	@(link_name = "ImGui_ShrinkWidths")
	ShrinkWidths :: proc(items: ^ShrinkWidthItem, count: c.int, width_excess: f32) ---
	// Parameter stacks (shared)
	@(link_name = "ImGui_GetStyleVarInfo")
	GetStyleVarInfo :: proc(idx: StyleVar) -> ^StyleVarInfo ---
	@(link_name = "ImGui_BeginDisabledOverrideReenable")
	BeginDisabledOverrideReenable :: proc() ---
	@(link_name = "ImGui_EndDisabledOverrideReenable")
	EndDisabledOverrideReenable :: proc() ---
	// Logging/Capture
	@(link_name = "ImGui_LogBegin")
	LogBegin :: proc(flags: LogFlags, auto_open_depth: c.int) --- // -> BeginCapture() when we design v2 api, for now stay under the radar by using the old name.
	@(link_name = "ImGui_LogToBuffer")
	LogToBuffer :: proc(auto_open_depth: c.int = -1) --- // Start logging/capturing to internal buffer
	@(link_name = "ImGui_LogRenderedText")
	LogRenderedText :: proc(ref_pos: ^Vec2, text: cstring, text_end: cstring = nil) ---
	@(link_name = "ImGui_LogSetNextTextDecoration")
	LogSetNextTextDecoration :: proc(prefix: cstring, suffix: cstring) ---
	// Childs
	@(link_name = "ImGui_BeginChildEx")
	BeginChildEx :: proc(name: cstring, id: ID, size_arg: Vec2, child_flags: ChildFlags, window_flags: WindowFlags) -> bool ---
	// Popups, Modals
	@(link_name = "ImGui_BeginPopupEx")
	BeginPopupEx :: proc(id: ID, extra_window_flags: WindowFlags) -> bool ---
	@(link_name = "ImGui_BeginPopupMenuEx")
	BeginPopupMenuEx :: proc(id: ID, label: cstring, extra_window_flags: WindowFlags) -> bool ---
	@(link_name = "ImGui_OpenPopupEx")
	OpenPopupEx :: proc(id: ID, popup_flags: PopupFlags = PopupFlags_None) ---
	@(link_name = "ImGui_ClosePopupToLevel")
	ClosePopupToLevel :: proc(remaining: c.int, restore_focus_to_window_under_popup: bool) ---
	@(link_name = "ImGui_ClosePopupsOverWindow")
	ClosePopupsOverWindow :: proc(ref_window: ^Window, restore_focus_to_window_under_popup: bool) ---
	@(link_name = "ImGui_ClosePopupsExceptModals")
	ClosePopupsExceptModals :: proc() ---
	@(link_name = "ImGui_IsPopupOpenID")
	IsPopupOpenID :: proc(id: ID, popup_flags: PopupFlags) -> bool ---
	@(link_name = "ImGui_GetPopupAllowedExtentRect")
	GetPopupAllowedExtentRect :: proc(window: ^Window) -> Rect ---
	@(link_name = "ImGui_GetTopMostPopupModal")
	GetTopMostPopupModal :: proc() -> ^Window ---
	@(link_name = "ImGui_GetTopMostAndVisiblePopupModal")
	GetTopMostAndVisiblePopupModal :: proc() -> ^Window ---
	@(link_name = "ImGui_FindBlockingModal")
	FindBlockingModal :: proc(window: ^Window) -> ^Window ---
	@(link_name = "ImGui_FindBestWindowPosForPopup")
	FindBestWindowPosForPopup :: proc(window: ^Window) -> Vec2 ---
	@(link_name = "ImGui_FindBestWindowPosForPopupEx")
	FindBestWindowPosForPopupEx :: proc(ref_pos: Vec2, size: Vec2, last_dir: ^Dir, r_outer: Rect, r_avoid: Rect, policy: PopupPositionPolicy) -> Vec2 ---
	// Tooltips
	@(link_name = "ImGui_BeginTooltipEx")
	BeginTooltipEx :: proc(tooltip_flags: TooltipFlags, extra_window_flags: WindowFlags) -> bool ---
	@(link_name = "ImGui_BeginTooltipHidden")
	BeginTooltipHidden :: proc() -> bool ---
	// Menus
	@(link_name = "ImGui_BeginViewportSideBar")
	BeginViewportSideBar :: proc(name: cstring, viewport: ^Viewport, dir: Dir, size: f32, window_flags: WindowFlags) -> bool ---
	@(link_name = "ImGui_BeginMenuWithIcon")
	BeginMenuWithIcon :: proc(label: cstring, icon: cstring, enabled: bool = true) -> bool ---
	@(link_name = "ImGui_MenuItemWithIcon")
	MenuItemWithIcon :: proc(label: cstring, icon: cstring, shortcut: cstring = nil, selected: bool = false, enabled: bool = true) -> bool ---
	// Combos
	@(link_name = "ImGui_BeginComboPopup")
	BeginComboPopup :: proc(popup_id: ID, bb: Rect, flags: ComboFlags) -> bool ---
	@(link_name = "ImGui_BeginComboPreview")
	BeginComboPreview :: proc() -> bool ---
	@(link_name = "ImGui_EndComboPreview")
	EndComboPreview :: proc() ---
	// Keyboard/Gamepad Navigation
	@(link_name = "ImGui_NavInitWindow")
	NavInitWindow :: proc(window: ^Window, force_reinit: bool) ---
	@(link_name = "ImGui_NavInitRequestApplyResult")
	NavInitRequestApplyResult :: proc() ---
	@(link_name = "ImGui_NavMoveRequestButNoResultYet")
	NavMoveRequestButNoResultYet :: proc() -> bool ---
	@(link_name = "ImGui_NavMoveRequestSubmit")
	NavMoveRequestSubmit :: proc(move_dir: Dir, clip_dir: Dir, move_flags: NavMoveFlags, scroll_flags: ScrollFlags) ---
	@(link_name = "ImGui_NavMoveRequestForward")
	NavMoveRequestForward :: proc(move_dir: Dir, clip_dir: Dir, move_flags: NavMoveFlags, scroll_flags: ScrollFlags) ---
	@(link_name = "ImGui_NavMoveRequestResolveWithLastItem")
	NavMoveRequestResolveWithLastItem :: proc(result: ^NavItemData) ---
	@(link_name = "ImGui_NavMoveRequestResolveWithPastTreeNode")
	NavMoveRequestResolveWithPastTreeNode :: proc(result: ^NavItemData, tree_node_data: ^TreeNodeStackData) ---
	@(link_name = "ImGui_NavMoveRequestCancel")
	NavMoveRequestCancel :: proc() ---
	@(link_name = "ImGui_NavMoveRequestApplyResult")
	NavMoveRequestApplyResult :: proc() ---
	@(link_name = "ImGui_NavMoveRequestTryWrapping")
	NavMoveRequestTryWrapping :: proc(window: ^Window, move_flags: NavMoveFlags) ---
	@(link_name = "ImGui_NavHighlightActivated")
	NavHighlightActivated :: proc(id: ID) ---
	@(link_name = "ImGui_NavClearPreferredPosForAxis")
	NavClearPreferredPosForAxis :: proc(axis: Axis) ---
	@(link_name = "ImGui_SetNavCursorVisibleAfterMove")
	SetNavCursorVisibleAfterMove :: proc() ---
	@(link_name = "ImGui_NavUpdateCurrentWindowIsScrollPushableX")
	NavUpdateCurrentWindowIsScrollPushableX :: proc() ---
	@(link_name = "ImGui_SetNavWindow")
	SetNavWindow :: proc(window: ^Window) ---
	@(link_name = "ImGui_SetNavID")
	SetNavID :: proc(id: ID, nav_layer: NavLayer, focus_scope_id: ID, rect_rel: Rect) ---
	@(link_name = "ImGui_SetNavFocusScope")
	SetNavFocusScope :: proc(focus_scope_id: ID) ---
	// Focus/Activation
	// This should be part of a larger set of API: FocusItem(offset = -1), FocusItemByID(id), ActivateItem(offset = -1), ActivateItemByID(id) etc. which are
	// much harder to design and implement than expected. I have a couple of private branches on this matter but it's not simple. For now implementing the easy ones.
	@(link_name = "ImGui_FocusItem")
	FocusItem :: proc() --- // Focus last item (no selection/activation).
	@(link_name = "ImGui_ActivateItemByID")
	ActivateItemByID :: proc(id: ID) --- // Activate an item by ID (button, checkbox, tree node etc.). Activation is queued and processed on the next frame when the item is encountered again.
	// Inputs
	// FIXME: Eventually we should aim to move e.g. IsActiveIdUsingKey() into IsKeyXXX functions.
	@(link_name = "ImGui_IsNamedKey")
	IsNamedKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsNamedKeyOrMod")
	IsNamedKeyOrMod :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsLegacyKey")
	IsLegacyKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsKeyboardKey")
	IsKeyboardKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsGamepadKey")
	IsGamepadKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsMouseKey")
	IsMouseKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsAliasKey")
	IsAliasKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_IsLRModKey")
	IsLRModKey :: proc(key: Key) -> bool ---
	@(link_name = "ImGui_FixupKeyChord")
	FixupKeyChord :: proc(key_chord: KeyChord) -> KeyChord ---
	@(link_name = "ImGui_ConvertSingleModFlagToKey")
	ConvertSingleModFlagToKey :: proc(key: Key) -> Key ---
	@(link_name = "ImGui_GetKeyDataImGuiContextPtr")
	GetKeyDataImGuiContextPtr :: proc(ctx: ^Context, key: Key) -> ^KeyData ---
	@(link_name = "ImGui_GetKeyData")
	GetKeyData :: proc(key: Key) -> ^KeyData ---
	@(link_name = "ImGui_GetKeyChordName")
	GetKeyChordName :: proc(key_chord: KeyChord) -> cstring ---
	@(link_name = "ImGui_MouseButtonToKey")
	MouseButtonToKey :: proc(button: MouseButton) -> Key ---
	@(link_name = "ImGui_IsMouseDragPastThreshold")
	IsMouseDragPastThreshold :: proc(button: MouseButton, lock_threshold: f32 = -1.0) -> bool ---
	@(link_name = "ImGui_GetKeyMagnitude2d")
	GetKeyMagnitude2d :: proc(key_left: Key, key_right: Key, key_up: Key, key_down: Key) -> Vec2 ---
	@(link_name = "ImGui_GetNavTweakPressedAmount")
	GetNavTweakPressedAmount :: proc(axis: Axis) -> f32 ---
	@(link_name = "ImGui_CalcTypematicRepeatAmount")
	CalcTypematicRepeatAmount :: proc(t0: f32, t1: f32, repeat_delay: f32, repeat_rate: f32) -> c.int ---
	@(link_name = "ImGui_GetTypematicRepeatRate")
	GetTypematicRepeatRate :: proc(flags: InputFlags, repeat_delay: ^f32, repeat_rate: ^f32) ---
	@(link_name = "ImGui_TeleportMousePos")
	TeleportMousePos :: proc(pos: Vec2) ---
	@(link_name = "ImGui_SetActiveIdUsingAllKeyboardKeys")
	SetActiveIdUsingAllKeyboardKeys :: proc() ---
	@(link_name = "ImGui_IsActiveIdUsingNavDir")
	...
	@(link_name = "ImGui_GetKeyOwner")
	GetKeyOwner :: proc(key: Key) -> ID ---
	@(link_name = "ImGui_SetKeyOwner")
	SetKeyOwner :: proc(key: Key, owner_id: ID, flags: InputFlags = {}) ---
	@(link_name = "ImGui_SetKeyOwnersForKeyChord")
	SetKeyOwnersForKeyChord :: proc(key: KeyChord, owner_id: ID, flags: InputFlags = {}) ---
	@(link_name = "ImGui_SetItemKeyOwnerImGuiInputFlags")
	SetItemKeyOwnerImGuiInputFlags :: proc(key: Key, flags: InputFlags) --- // Set key owner to last item if it is hovered or active. Equivalent to 'if (IsItemHovered() || IsItemActive()) { SetKeyOwner(key, GetItemID());'.
	@(link_name = "ImGui_TestKeyOwner")
	TestKeyOwner :: proc(key: Key, owner_id: ID) -> bool --- // Test that key is either not owned, either owned by 'owner_id'
	@(link_name = "ImGui_GetKeyOwnerData")
	GetKeyOwnerData :: proc(ctx: ^Context, key: Key) -> ^KeyOwnerData ---
	...
	@(link_name = "ImGui_IsKeyDownID")
	IsKeyDownID :: proc(key: Key, owner_id: ID) -> bool ---
	@(link_name = "ImGui_IsKeyPressedImGuiInputFlags")
	IsKeyPressedImGuiInputFlags :: proc(key: Key, flags: InputFlags, owner_id: ID = {}) -> bool --- // Important: when transitioning from old to new IsKeyPressed(): old API has "bool repeat = true", so would default to repeat. New API requiress explicit ImGuiInputFlags_Repeat.
	@(link_name = "ImGui_IsKeyReleasedID")
	IsKeyReleasedID :: proc(key: Key, owner_id: ID) -> bool ---
	@(link_name = "ImGui_IsKeyChordPressedImGuiInputFlags")
	IsKeyChordPressedImGuiInputFlags :: proc(key_chord: KeyChord, flags: InputFlags, owner_id: ID = {}) -> bool ---
	@(link_name = "ImGui_IsMouseDownID")
	IsMouseDownID :: proc(button: MouseButton, owner_id: ID) -> bool ---
	@(link_name = "ImGui_IsMouseClickedImGuiInputFlags")
	IsMouseClickedImGuiInputFlags :: proc(button: MouseButton, flags: InputFlags, owner_id: ID = {}) -> bool ---
	@(link_name = "ImGui_IsMouseReleasedID")
	IsMouseReleasedID :: proc(button: MouseButton, owner_id: ID) -> bool ---
	@(link_name = "ImGui_IsMouseDoubleClickedID")
	IsMouseDoubleClickedID :: proc(button: MouseButton, owner_id: ID) -> bool ---
	...
	@(link_name = "ImGui_ShortcutID")
	ShortcutID :: proc(key_chord: KeyChord, flags: InputFlags, owner_id: ID) -> bool ---
	@(link_name = "ImGui_SetShortcutRouting")
	SetShortcutRouting :: proc(key_chord: KeyChord, flags: InputFlags, owner_id: ID) -> bool --- // owner_id needs to be explicit and cannot be 0
	@(link_name = "ImGui_TestShortcutRouting")
	TestShortcutRouting :: proc(key_chord: KeyChord, owner_id: ID) -> bool ---
	@(link_name = "ImGui_GetShortcutRoutingData")
	GetShortcutRoutingData :: proc(key_chord: KeyChord) -> ^KeyRoutingData ---
	...
	@(link_name = "ImGui_PushFocusScope")
	PushFocusScope :: proc(id: ID) ---
	@(link_name = "ImGui_PopFocusScope")
	PopFocusScope :: proc() ---
	@(link_name = "ImGui_GetCurrentFocusScope")
	GetCurrentFocusScope :: proc() -> ID --- // Focus scope we are outputting into, set by PushFocusScope()
	// Drag and Drop
	@(link_name = "ImGui_IsDragDropActive")
	IsDragDropActive :: proc() -> bool ---
	@(link_name = "ImGui_BeginDragDropTargetCustom")
	BeginDragDropTargetCustom :: proc(bb: Rect, id: ID) -> bool ---
	@(link_name = "ImGui_ClearDragDrop")
	ClearDragDrop :: proc() ---
	@(link_name = "ImGui_IsDragDropPayloadBeingAccepted")
	IsDragDropPayloadBeingAccepted :: proc() -> bool ---
	@(link_name = "ImGui_RenderDragDropTargetRect")
	RenderDragDropTargetRect :: proc(bb: Rect, item_clip_rect: Rect) ---
	// Typing-Select API
	...
	@(link_name = "ImGui_GetTypingSelectRequest")
	GetTypingSelectRequest :: proc(flags: TypingSelectFlags = TypingSelectFlags_None) -> ^TypingSelectRequest ---
	@(link_name = "ImGui_TypingSelectFindMatch")
	TypingSelectFindMatch :: proc(req: ^TypingSelectRequest, items_count: c.int, get_item_name_func: proc "c" (arg_0: rawptr, arg_1: c.int) -> cstring, user_data: rawptr, nav_item_idx: c.int) -> c.int ---
	@(link_name = "ImGui_TypingSelectFindNextSingleCharMatch")
	TypingSelectFindNextSingleCharMatch :: proc(req: ^TypingSelectRequest, items_count: c.int, get_item_name_func: proc "c" (arg_0: rawptr, arg_1: c.int) -> cstring, user_data: rawptr, nav_item_idx: c.int) -> c.int ---
	@(link_name = "ImGui_TypingSelectFindBestLeadingMatch")
	TypingSelectFindBestLeadingMatch :: proc(req: ^TypingSelectRequest, items_count: c.int, get_item_name_func: proc "c" (arg_0: rawptr, arg_1: c.int) -> cstring, user_data: rawptr) -> c.int ---
	// Box-Select API
	@(link_name = "ImGui_BeginBoxSelect")
	BeginBoxSelect :: proc(scope_rect: Rect, window: ^Window, box_select_id: ID, ms_flags: MultiSelectFlags) -> bool ---
	@(link_name = "ImGui_EndBoxSelect")
	EndBoxSelect :: proc(scope_rect: Rect, ms_flags: MultiSelectFlags) ---
	// Multi-Select API
	@(link_name = "ImGui_MultiSelectItemHeader")
	MultiSelectItemHeader :: proc(id: ID, p_selected: ^bool, p_button_flags: ^ButtonFlags) ---
	@(link_name = "ImGui_MultiSelectItemFooter")
	MultiSelectItemFooter :: proc(id: ID, p_selected: ^bool, p_pressed: ^bool) ---
	@(link_name = "ImGui_MultiSelectAddSetAll")
	MultiSelectAddSetAll :: proc(ms: ^MultiSelectTempData, selected: bool) ---
	@(link_name = "ImGui_MultiSelectAddSetRange")
	MultiSelectAddSetRange :: proc(ms: ^MultiSelectTempData, selected: bool, range_dir: c.int, first_item: SelectionUserData, last_item: SelectionUserData) ---
	@(link_name = "ImGui_GetBoxSelectState")
	GetBoxSelectState :: proc(id: ID) -> ^BoxSelectState ---
	@(link_name = "ImGui_GetMultiSelectState")
	GetMultiSelectState :: proc(id: ID) -> ^MultiSelectState ---
	// Internal Columns API (this is not exposed because we will encourage transitioning to the Tables API)
	@(link_name = "ImGui_SetWindowClipRectBeforeSetChannel")
	SetWindowClipRectBeforeSetChannel :: proc(window: ^Window, clip_rect: Rect) ---
	@(link_name = "ImGui_BeginColumns")
	BeginColumns :: proc(str_id: cstring, count: c.int, flags: OldColumnFlags = {}) --- // setup number of columns. use an identifier to distinguish multiple column sets. close with EndColumns().
	@(link_name = "ImGui_EndColumns")
	EndColumns :: proc() --- // close columns
	@(link_name = "ImGui_PushColumnClipRect")
	PushColumnClipRect :: proc(column_index: c.int) ---
	@(link_name = "ImGui_PushColumnsBackground")
	PushColumnsBackground :: proc() ---
	@(link_name = "ImGui_PopColumnsBackground")
	PopColumnsBackground :: proc() ---
	@(link_name = "ImGui_GetColumnsID")
	GetColumnsID :: proc(str_id: cstring, count: c.int) -> ID ---
	@(link_name = "ImGui_FindOrCreateColumns")
	FindOrCreateColumns :: proc(window: ^Window, id: ID) -> ^OldColumns ---
	@(link_name = "ImGui_GetColumnOffsetFromNorm")
	GetColumnOffsetFromNorm :: proc(columns: ^OldColumns, offset_norm: f32) -> f32 ---
	@(link_name = "ImGui_GetColumnNormFromOffset")
	GetColumnNormFromOffset :: proc(columns: ^OldColumns, offset: f32) -> f32 ---
	// Tables: Candidates for public API
	@(link_name = "ImGui_TableOpenContextMenu")
	TableOpenContextMenu :: proc(column_n: c.int = -1) ---
	@(link_name = "ImGui_TableSetColumnWidth")
	TableSetColumnWidth :: proc(column_n: c.int, width: f32) ---
	@(link_name = "ImGui_TableSetColumnSortDirection")
	TableSetColumnSortDirection :: proc(column_n: c.int, sort_direction: SortDirection, append_to_sort_specs: bool) ---
	@(link_name = "ImGui_TableGetHoveredRow")
	TableGetHoveredRow :: proc() -> c.int --- // Retrieve *PREVIOUS FRAME* hovered row. This difference with TableGetHoveredColumn() is the reason why this is not public yet.
	@(link_name = "ImGui_TableGetHeaderRowHeight")
	TableGetHeaderRowHeight :: proc() -> f32 ---
	@(link_name = "ImGui_TableGetHeaderAngledMaxLabelWidth")
	TableGetHeaderAngledMaxLabelWidth :: proc() -> f32 ---
	@(link_name = "ImGui_TablePushBackgroundChannel")
	TablePushBackgroundChannel :: proc() ---
	@(link_name = "ImGui_TablePopBackgroundChannel")
	TablePopBackgroundChannel :: proc() ---
	@(link_name = "ImGui_TableAngledHeadersRowEx")
	TableAngledHeadersRowEx :: proc(row_id: ID, angle: f32, max_label_width: f32, data: ^TableHeaderData, data_count: c.int) ---
	// Tables: Internals
	@(link_name = "ImGui_GetCurrentTable")
	GetCurrentTable :: proc() -> ^Table ---
	@(link_name = "ImGui_TableFindByID")
	TableFindByID :: proc(id: ID) -> ^Table ---
	@(link_name = "ImGui_BeginTableWithID")
	BeginTableWithID :: proc(name: cstring, id: ID, columns_count: c.int, flags: TableFlags = {}, outer_size: Vec2 = {0, 0}, inner_width: f32 = 0.0) -> bool ---
	@(link_name = "ImGui_TableBeginInitMemory")
	TableBeginInitMemory :: proc(table: ^Table, columns_count: c.int) ---
	@(link_name = "ImGui_TableBeginApplyRequests")
	TableBeginApplyRequests :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableSetupDrawChannels")
	TableSetupDrawChannels :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableUpdateLayout")
	TableUpdateLayout :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableUpdateBorders")
	TableUpdateBorders :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableUpdateColumnsWeightFromWidth")
	TableUpdateColumnsWeightFromWidth :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableDrawBorders")
	TableDrawBorders :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableDrawDefaultContextMenu")
	TableDrawDefaultContextMenu :: proc(table: ^Table, flags_for_section_to_display: TableFlags) ---
	@(link_name = "ImGui_TableBeginContextMenuPopup")
	TableBeginContextMenuPopup :: proc(table: ^Table) -> bool ---
	@(link_name = "ImGui_TableMergeDrawChannels")
	TableMergeDrawChannels :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableGetInstanceData")
	TableGetInstanceData :: proc(table: ^Table, instance_no: c.int) -> ^TableInstanceData ---
	@(link_name = "ImGui_TableGetInstanceID")
	TableGetInstanceID :: proc(table: ^Table, instance_no: c.int) -> ID ---
	@(link_name = "ImGui_TableSortSpecsSanitize")
	TableSortSpecsSanitize :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableSortSpecsBuild")
	TableSortSpecsBuild :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableGetColumnNextSortDirection")
	TableGetColumnNextSortDirection :: proc(column: ^TableColumn) -> SortDirection ---
	@(link_name = "ImGui_TableFixColumnSortDirection")
	TableFixColumnSortDirection :: proc(table: ^Table, column: ^TableColumn) ---
	@(link_name = "ImGui_TableGetColumnWidthAuto")
	TableGetColumnWidthAuto :: proc(table: ^Table, column: ^TableColumn) -> f32 ---
	@(link_name = "ImGui_TableBeginRow")
	TableBeginRow :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableEndRow")
	TableEndRow :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableBeginCell")
	TableBeginCell :: proc(table: ^Table, column_n: c.int) ---
	@(link_name = "ImGui_TableEndCell")
	TableEndCell :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableGetCellBgRect")
	TableGetCellBgRect :: proc(table: ^Table, column_n: c.int) -> Rect ---
	@(link_name = "ImGui_TableGetColumnNameImGuiTablePtr")
	TableGetColumnNameImGuiTablePtr :: proc(table: ^Table, column_n: c.int) -> cstring ---
	@(link_name = "ImGui_TableGetColumnResizeID")
	TableGetColumnResizeID :: proc(table: ^Table, column_n: c.int, instance_no: c.int = {}) -> ID ---
	@(link_name = "ImGui_TableCalcMaxColumnWidth")
	TableCalcMaxColumnWidth :: proc(table: ^Table, column_n: c.int) -> f32 ---
	@(link_name = "ImGui_TableSetColumnWidthAutoSingle")
	TableSetColumnWidthAutoSingle :: proc(table: ^Table, column_n: c.int) ---
	@(link_name = "ImGui_TableSetColumnWidthAutoAll")
	TableSetColumnWidthAutoAll :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableRemove")
	TableRemove :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableGcCompactTransientBuffers")
	TableGcCompactTransientBuffers :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableGcCompactTransientBuffersImGuiTableTempDataPtr")
	TableGcCompactTransientBuffersImGuiTableTempDataPtr :: proc(table: ^TableTempData) ---
	@(link_name = "ImGui_TableGcCompactSettings")
	TableGcCompactSettings :: proc() ---
	// Tables: Settings
	@(link_name = "ImGui_TableLoadSettings")
	TableLoadSettings :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableSaveSettings")
	TableSaveSettings :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableResetSettings")
	TableResetSettings :: proc(table: ^Table) ---
	@(link_name = "ImGui_TableGetBoundSettings")
	TableGetBoundSettings :: proc(table: ^Table) -> ^TableSettings ---
	@(link_name = "ImGui_TableSettingsAddSettingsHandler")
	TableSettingsAddSettingsHandler :: proc() ---
	@(link_name = "ImGui_TableSettingsCreate")
	TableSettingsCreate :: proc(id: ID, columns_count: c.int) -> ^TableSettings ---
	@(link_name = "ImGui_TableSettingsFindByID")
	TableSettingsFindByID :: proc(id: ID) -> ^TableSettings ---
	// Tab Bars
	@(link_name = "ImGui_GetCurrentTabBar")
	GetCurrentTabBar :: proc() -> ^TabBar ---
	@(link_name = "ImGui_BeginTabBarEx")
	BeginTabBarEx :: proc(tab_bar: ^TabBar, bb: Rect, flags: TabBarFlags) -> bool ---
	@(link_name = "ImGui_TabBarFindTabByID")
	TabBarFindTabByID :: proc(tab_bar: ^TabBar, tab_id: ID) -> ^TabItem ---
	@(link_name = "ImGui_TabBarFindTabByOrder")
	TabBarFindTabByOrder :: proc(tab_bar: ^TabBar, order: c.int) -> ^TabItem ---
	@(link_name = "ImGui_TabBarGetCurrentTab")
	TabBarGetCurrentTab :: proc(tab_bar: ^TabBar) -> ^TabItem ---
	@(link_name = "ImGui_TabBarGetTabOrder")
	TabBarGetTabOrder :: proc(tab_bar: ^TabBar, tab: ^TabItem) -> c.int ---
	@(link_name = "ImGui_TabBarGetTabName")
	TabBarGetTabName :: proc(tab_bar: ^TabBar, tab: ^TabItem) -> cstring ---
	@(link_name = "ImGui_TabBarRemoveTab")
	TabBarRemoveTab :: proc(tab_bar: ^TabBar, tab_id: ID) ---
	@(link_name = "ImGui_TabBarCloseTab")
	TabBarCloseTab :: proc(tab_bar: ^TabBar, tab: ^TabItem) ---
	@(link_name = "ImGui_TabBarQueueFocus")
	TabBarQueueFocus :: proc(tab_bar: ^TabBar, tab: ^TabItem) ---
	@(link_name = "ImGui_TabBarQueueFocusStr")
	TabBarQueueFocusStr :: proc(tab_bar: ^TabBar, tab_name: cstring) ---
	@(link_name = "ImGui_TabBarQueueReorder")
	TabBarQueueReorder :: proc(tab_bar: ^TabBar, tab: ^TabItem, offset: c.int) ---
	@(link_name = "ImGui_TabBarQueueReorderFromMousePos")
	TabBarQueueReorderFromMousePos :: proc(tab_bar: ^TabBar, tab: ^TabItem, mouse_pos: Vec2) ---
	@(link_name = "ImGui_TabBarProcessReorder")
	TabBarProcessReorder :: proc(tab_bar: ^TabBar) -> bool ---
	@(link_name = "ImGui_TabItemEx")
	TabItemEx :: proc(tab_bar: ^TabBar, label: cstring, p_open: ^bool, flags: TabItemFlags, docked_window: ^Window) -> bool ---
	@(link_name = "ImGui_TabItemSpacing")
	TabItemSpacing :: proc(str_id: cstring, flags: TabItemFlags, width: f32) ---
	@(link_name = "ImGui_TabItemCalcSizeStr")
	TabItemCalcSizeStr :: proc(label: cstring, has_close_button_or_unsaved_marker: bool) -> Vec2 ---
	@(link_name = "ImGui_TabItemCalcSize")
	TabItemCalcSize :: proc(window: ^Window) -> Vec2 ---
	@(link_name = "ImGui_TabItemBackground")
	TabItemBackground :: proc(draw_list: ^DrawList, bb: Rect, flags: TabItemFlags, col: u32) ---
	@(link_name = "ImGui_TabItemLabelAndCloseButton")
	TabItemLabelAndCloseButton :: proc(draw_list: ^DrawList, bb: Rect, flags: TabItemFlags, frame_padding: Vec2, label: cstring, tab_id: ID, close_button_id: ID, is_contents_visible: bool, out_just_closed: ^bool, out_text_clipped: ^bool) ---
	// Render helpers
	// AVOID USING OUTSIDE OF IMGUI.CPP! NOT FOR PUBLIC CONSUMPTION. THOSE FUNCTIONS ARE A MESS. THEIR SIGNATURE AND BEHAVIOR WILL CHANGE, THEY NEED TO BE REFACTORED INTO SOMETHING DECENT.
	// NB: All position are in absolute pixels coordinates (we are never using window coordinates internally)
	@(link_name = "ImGui_RenderText")
	RenderText :: proc(pos: Vec2, text: cstring, text_end: cstring = nil, hide_text_after_hash: bool = true) ---
	@(link_name = "ImGui_RenderTextWrapped")
	RenderTextWrapped :: proc(pos: Vec2, text: cstring, text_end: cstring, wrap_width: f32) ---
	@(link_name = "ImGui_RenderTextClipped")
	RenderTextClipped :: proc(pos_min: Vec2, pos_max: Vec2, text: cstring, text_end: cstring, text_size_if_known: ^Vec2, align: Vec2 = {0, 0}, clip_rect: ^Rect = nil) ---
	@(link_name = "ImGui_RenderTextClippedWithDrawList")
	RenderTextClippedWithDrawList :: proc(draw_list: ^DrawList, pos_min: Vec2, pos_max: Vec2, text: cstring, text_end: cstring, text_size_if_known: ^Vec2, align: Vec2 = {0, 0}, clip_rect: ^Rect = nil) ---
	@(link_name = "ImGui_RenderTextEllipsis")
	RenderTextEllipsis :: proc(draw_list: ^DrawList, pos_min: Vec2, pos_max: Vec2, clip_max_x: f32, ellipsis_max_x: f32, text: cstring, text_end: cstring, text_size_if_known: ^Vec2) ---
	@(link_name = "ImGui_RenderFrame")
	RenderFrame :: proc(p_min: Vec2, p_max: Vec2, fill_col: u32, borders: bool = true, rounding: f32 = 0.0) ---
	@(link_name = "ImGui_RenderFrameBorder")
	RenderFrameBorder :: proc(p_min: Vec2, p_max: Vec2, rounding: f32 = 0.0) ---
	...
	RenderMouseCursor :: proc(pos: Vec2, scale: f32, mouse_cursor: MouseCursor, col_fill: u32, col_border: u32, col_shadow: u32) ---
	// Render helpers (those functions don't access any ImGui state!)
	@(link_name = "ImGui_RenderArrow")
	RenderArrow :: proc(draw_list: ^DrawList, pos: Vec2, col: u32, dir: Dir, scale: f32 = 1.0) ---
	@(link_name = "ImGui_RenderBullet")
	RenderBullet :: proc(draw_list: ^DrawList, pos: Vec2, col: u32) ---
	@(link_name = "ImGui_RenderCheckMark")
	RenderCheckMark :: proc(draw_list: ^DrawList, pos: Vec2, col: u32, sz: f32) ---
	@(link_name = "ImGui_RenderArrowPointingAt")
	RenderArrowPointingAt :: proc(draw_list: ^DrawList, pos: Vec2, half_sz: Vec2, direction: Dir, col: u32) ---
	@(link_name = "ImGui_RenderRectFilledRangeH")
	RenderRectFilledRangeH :: proc(draw_list: ^DrawList, rect: Rect, col: u32, x_start_norm: f32, x_end_norm: f32, rounding: f32) ---
	@(link_name = "ImGui_RenderRectFilledWithHole")
	RenderRectFilledWithHole :: proc(draw_list: ^DrawList, outer: Rect, inner: Rect, col: u32, rounding: f32) ---
	// Widgets
	@(link_name = "ImGui_TextEx")
	TextEx :: proc(text: cstring, text_end: cstring = nil, flags: TextFlags = {}) ---
	@(link_name = "ImGui_ButtonWithFlags")
	ButtonWithFlags :: proc(label: cstring, size_arg: Vec2 = {0, 0}, flags: ButtonFlags = {}) -> bool ---
	@(link_name = "ImGui_ArrowButtonEx")
	ArrowButtonEx :: proc(str_id: cstring, dir: Dir, size_arg: Vec2, flags: ButtonFlags = {}) -> bool ---
	@(link_name = "ImGui_ImageButtonWithFlags")
	ImageButtonWithFlags :: proc(id: ID, user_texture_id: TextureID, image_size: Vec2, uv0: Vec2, uv1: Vec2, bg_col: Vec4, tint_col: Vec4, flags: ButtonFlags = {}) -> bool ---
	@(link_name = "ImGui_SeparatorEx")
	SeparatorEx :: proc(flags: SeparatorFlags, thickness: f32 = 1.0) ---
	@(link_name = "ImGui_SeparatorTextEx")
	SeparatorTextEx :: proc(id: ID, label: cstring, label_end: cstring, extra_width: f32) ---
	@(link_name = "ImGui_CheckboxFlagsImS64Ptr")
	CheckboxFlagsImS64Ptr :: proc(label: cstring, flags: ^i64, flags_value: i64) -> bool ---
	@(link_name = "ImGui_CheckboxFlagsImU64Ptr")
	CheckboxFlagsImU64Ptr :: proc(label: cstring, flags: ^u64, flags_value: u64) -> bool ---
	// Widgets: Window Decorations
	@(link_name = "ImGui_CloseButton")
	CloseButton :: proc(id: ID, pos: Vec2) -> bool ---
	@(link_name = "ImGui_CollapseButton")
	CollapseButton :: proc(id: ID, pos: Vec2) -> bool ---
	@(link_name = "ImGui_Scrollbar")
	Scrollbar :: proc(axis: Axis) ---
	@(link_name = "ImGui_ScrollbarEx")
	ScrollbarEx :: proc(bb: Rect, id: ID, axis: Axis, p_scroll_v: ^i64, avail_v: i64, contents_v: i64, draw_rounding_flags: DrawFlags = {}) -> bool ---
	@(link_name = "ImGui_GetWindowScrollbarRect")
	GetWindowScrollbarRect :: proc(window: ^Window, axis: Axis) -> Rect ---
	@(link_name = "ImGui_GetWindowScrollbarID")
	GetWindowScrollbarID :: proc(window: ^Window, axis: Axis) -> ID ---
	@(link_name = "ImGui_GetWindowResizeCornerID")
	GetWindowResizeCornerID :: proc(window: ^Window, n: c.int) -> ID --- // 0..3: corners
	@(link_name = "ImGui_GetWindowResizeBorderID")
	GetWindowResizeBorderID :: proc(window: ^Window, dir: Dir) -> ID ---
	// Widgets low-level behaviors
	@(link_name = "ImGui_ButtonBehavior")
	ButtonBehavior :: proc(bb: Rect, id: ID, out_hovered: ^bool, out_held: ^bool, flags: ButtonFlags = {}) -> bool ---
	@(link_name = "ImGui_DragBehavior")
	DragBehavior :: proc(id: ID, data_type: DataType, p_v: rawptr, v_speed: f32, p_min: rawptr, p_max: rawptr, format: cstring, flags: SliderFlags) -> bool ---
	@(link_name = "ImGui_SliderBehavior")
	SliderBehavior :: proc(bb: Rect, id: ID, data_type: DataType, p_v: rawptr, p_min: rawptr, p_max: rawptr, format: cstring, flags: SliderFlags, out_grab_bb: ^Rect) -> bool ---
	@(link_name = "ImGui_SplitterBehavior")
	...
	// Widgets: Tree Nodes
	@(link_name = "ImGui_TreeNodeBehavior")
	TreeNodeBehavior :: proc(id: ID, flags: TreeNodeFlags, label: cstring, label_end: cstring = nil) -> bool ---
	@(link_name = "ImGui_TreePushOverrideID")
	TreePushOverrideID :: proc(id: ID) ---
	@(link_name = "ImGui_TreeNodeGetOpen")
	TreeNodeGetOpen :: proc(storage_id: ID) -> bool ---
	@(link_name = "ImGui_TreeNodeSetOpen")
	TreeNodeSetOpen :: proc(storage_id: ID, open: bool) ---
	@(link_name = "ImGui_TreeNodeUpdateNextOpen")
	TreeNodeUpdateNextOpen :: proc(storage_id: ID, flags: TreeNodeFlags) -> bool --- // Return open state. Consume previous SetNextItemOpen() data, if any. May return true when logging.
	// Data type helpers
	@(link_name = "ImGui_DataTypeGetInfo")
	DataTypeGetInfo :: proc(data_type: DataType) -> ^DataTypeInfo ---
	@(link_name = "ImGui_DataTypeFormatString")
	DataTypeFormatString :: proc(buf: cstring, buf_size: c.int, data_type: DataType, p_data: rawptr, format: cstring) -> c.int ---
	@(link_name = "ImGui_DataTypeApplyOp")
	DataTypeApplyOp :: proc(data_type: DataType, op: c.int, output: rawptr, arg_1: rawptr, arg_2: rawptr) ---
	@(link_name = "ImGui_DataTypeApplyFromText")
	DataTypeApplyFromText :: proc(buf: cstring, data_type: DataType, p_data: rawptr, format: cstring, p_data_when_empty: rawptr = nil) -> bool ---
	@(link_name = "ImGui_DataTypeCompare")
	DataTypeCompare :: proc(data_type: DataType, arg_1: rawptr, arg_2: rawptr) -> c.int ---
	@(link_name = "ImGui_DataTypeClamp")
	DataTypeClamp :: proc(data_type: DataType, p_data: rawptr, p_min: rawptr, p_max: rawptr) -> bool ---
	@(link_name = "ImGui_DataTypeIsZero")
	DataTypeIsZero :: proc(data_type: DataType, p_data: rawptr) -> bool ---
	// InputText
	@(link_name = "ImGui_InputTextWithHintAndSize")
	InputTextWithHintAndSize :: proc(label: cstring, hint: cstring, buf: cstring, buf_size: c.int, size_arg: Vec2, flags: InputTextFlags, callback: InputTextCallback = nil, user_data: rawptr = nil) -> bool ---
	@(link_name = "ImGui_InputTextDeactivateHook")
	InputTextDeactivateHook :: proc(id: ID) ---
	@(link_name = "ImGui_TempInputText")
	TempInputText :: proc(bb: Rect, id: ID, label: cstring, buf: cstring, buf_size: c.int, flags: InputTextFlags) -> bool ---
	@(link_name = "ImGui_TempInputScalar")
	TempInputScalar :: proc(bb: Rect, id: ID, label: cstring, data_type: DataType, p_data: rawptr, format: cstring, p_clamp_min: rawptr = nil, p_clamp_max: rawptr = nil) -> bool ---
	@(link_name = "ImGui_TempInputIsActive")
	TempInputIsActive :: proc(id: ID) -> bool ---
	@(link_name = "ImGui_SetNextItemRefVal")
	SetNextItemRefVal :: proc(data_type: DataType, p_data: rawptr) ---
	@(link_name = "ImGui_IsItemActiveAsInputText")
	IsItemActiveAsInputText :: proc() -> bool --- // This may be useful to apply workaround that a based on distinguish whenever an item is active as a text input field.
	// Color
	@(link_name = "ImGui_ColorTooltip")
	ColorTooltip :: proc(text: cstring, col: ^f32, flags: ColorEditFlags) ---
	@(link_name = "ImGui_ColorEditOptionsPopup")
	ColorEditOptionsPopup :: proc(col: ^f32, flags: ColorEditFlags) ---
	@(link_name = "ImGui_ColorPickerOptionsPopup")
	ColorPickerOptionsPopup :: proc(ref_col: ^f32, flags: ColorEditFlags) ---
	// Plot
	@(link_name = "ImGui_PlotEx")
	PlotEx :: proc(plot_type: PlotType, label: cstring, values_getter: proc "c" (data: rawptr, idx: c.int) -> f32, data: rawptr, values_count: c.int, values_offset: c.int, overlay_text: cstring, scale_min: f32, scale_max: f32, size_arg: Vec2) -> c.int ---
	// Shade functions (write over already created vertices)
	@(link_name = "ImGui_ShadeVertsLinearColorGradientKeepAlpha")
	ShadeVertsLinearColorGradientKeepAlpha :: proc(draw_list: ^DrawList, vert_start_idx: c.int, vert_end_idx: c.int, gradient_p0: Vec2, gradient_p1: Vec2, col0: u32, col1: u32) ---
	@(link_name = "ImGui_ShadeVertsLinearUV")
	ShadeVertsLinearUV :: proc(draw_list: ^DrawList, vert_start_idx: c.int, vert_end_idx: c.int, a: Vec2, b: Vec2, uv_a: Vec2, uv_b: Vec2, clamp: bool) ---
	@(link_name = "ImGui_ShadeVertsTransformPos")
	ShadeVertsTransformPos :: proc(draw_list: ^DrawList, vert_start_idx: c.int, vert_end_idx: c.int, pivot_in: Vec2, cos_a: f32, sin_a: f32, pivot_out: Vec2) ---
	// Garbage collection
	@(link_name = "ImGui_GcCompactTransientMiscBuffers")
	GcCompactTransientMiscBuffers :: proc() ---
	@(link_name = "ImGui_GcCompactTransientWindowBuffers")
	GcCompactTransientWindowBuffers :: proc(window: ^Window) ---
	@(link_name = "ImGui_GcAwakeTransientWindowBuffers")
	GcAwakeTransientWindowBuffers :: proc(window: ^Window) ---
	// Error handling, State Recovery
	@(link_name = "ImGui_ErrorLog")
	ErrorLog :: proc(msg: cstring) -> bool ---
	@(link_name = "ImGui_ErrorRecoveryStoreState")
	ErrorRecoveryStoreState :: proc(state_out: ^ErrorRecoveryState) ---
	@(link_name = "ImGui_ErrorRecoveryTryToRecoverState")
	ErrorRecoveryTryToRecoverState :: proc(state_in: ^ErrorRecoveryState) ---
	@(link_name = "ImGui_ErrorRecoveryTryToRecoverWindowState")
	ErrorRecoveryTryToRecoverWindowState :: proc(state_in: ^ErrorRecoveryState) ---
	@(link_name = "ImGui_ErrorCheckUsingSetCursorPosToExtendParentBoundaries")
	ErrorCheckUsingSetCursorPosToExtendParentBoundaries :: proc() ---
	@(link_name = "ImGui_ErrorCheckEndFrameFinalizeErrorTooltip")
	ErrorCheckEndFrameFinalizeErrorTooltip :: proc() ---
	@(link_name = "ImGui_BeginErrorTooltip")
	BeginErrorTooltip :: proc() -> bool ---
	@(link_name = "ImGui_EndErrorTooltip")
	EndErrorTooltip :: proc() ---
	// Debug Tools
	@(link_name = "ImGui_DebugAllocHook")
	DebugAllocHook :: proc(info: ^DebugAllocInfo, frame_count: c.int, ptr: rawptr, size: c.size_t) --- // size >= 0 : alloc, size = -1 : free
	@(link_name = "ImGui_DebugDrawCursorPos")
	DebugDrawCursorPos :: proc(col: u32 = u32(0xff0000ff)) ---
	@(link_name = "ImGui_DebugDrawLineExtents")
	DebugDrawLineExtents :: proc(col: u32 = u32(0xff0000ff)) ---
	@(link_name = "ImGui_DebugDrawItemRect")
	DebugDrawItemRect :: proc(col: u32 = u32(0xff0000ff)) ---
	@(link_name = "ImGui_DebugTextUnformattedWithLocateItem")
	DebugTextUnformattedWithLocateItem :: proc(line_begin: cstring, line_end: cstring) ---
	@(link_name = "ImGui_DebugLocateItem")
	DebugLocateItem :: proc(target_id: ID) --- // Call sparingly: only 1 at the same time!
	@(link_name = "ImGui_DebugLocateItemOnHover")
	DebugLocateItemOnHover :: proc(target_id: ID) --- // Only call on reaction to a mouse Hover: because only 1 at the same time!
	@(link_name = "ImGui_DebugLocateItemResolveWithLastItem")
	DebugLocateItemResolveWithLastItem :: proc() ---
	@(link_name = "ImGui_DebugBreakClearData")
	DebugBreakClearData :: proc() ---
	@(link_name = "ImGui_DebugBreakButton")
	DebugBreakButton :: proc(label: cstring, description_of_location: cstring) -> bool ---
	@(link_name = "ImGui_DebugBreakButtonTooltip")
	DebugBreakButtonTooltip :: proc(keyboard_only: bool, description_of_location: cstring) ---
	@(link_name = "ImGui_ShowFontAtlas")
	ShowFontAtlas :: proc(atlas: ^FontAtlas) ---
	@(link_name = "ImGui_DebugHookIdInfo")
	DebugHookIdInfo :: proc(id: ID, data_type: DataType, data_id: rawptr, data_id_end: rawptr) ---
	@(link_name = "ImGui_DebugNodeColumns")
	DebugNodeColumns :: proc(columns: ^OldColumns) ---
	@(link_name = "ImGui_DebugNodeDrawList")
	DebugNodeDrawList :: proc(window: ^Window, viewport: ^ViewportP, draw_list: ^DrawList, label: cstring) ---
	@(link_name = "ImGui_DebugNodeDrawCmdShowMeshAndBoundingBox")
	DebugNodeDrawCmdShowMeshAndBoundingBox :: proc(out_draw_list: ^DrawList, draw_list: ^DrawList, draw_cmd: ^DrawCmd, show_mesh: bool, show_aabb: bool) ---
	@(link_name = "ImGui_DebugNodeFont")
	DebugNodeFont :: proc(font: ^Font) ---
	@(link_name = "ImGui_DebugNodeFontGlyph")
	DebugNodeFontGlyph :: proc(font: ^Font, glyph: ^FontGlyph) ---
	@(link_name = "ImGui_DebugNodeStorage")
	DebugNodeStorage :: proc(storage: ^Storage, label: cstring) ---
	@(link_name = "ImGui_DebugNodeTabBar")
	DebugNodeTabBar :: proc(tab_bar: ^TabBar, label: cstring) ---
	@(link_name = "ImGui_DebugNodeTable")
	DebugNodeTable :: proc(table: ^Table) ---
	@(link_name = "ImGui_DebugNodeTableSettings")
	DebugNodeTableSettings :: proc(settings: ^TableSettings) ---
	@(link_name = "ImGui_DebugNodeTypingSelectState")
	DebugNodeTypingSelectState :: proc(state: ^TypingSelectState) ---
	@(link_name = "ImGui_DebugNodeMultiSelectState")
	DebugNodeMultiSelectState :: proc(state: ^MultiSelectState) ---
	@(link_name = "ImGui_DebugNodeWindow")
	DebugNodeWindow :: proc(window: ^Window, label: cstring) ---
	@(link_name = "ImGui_DebugNodeWindowSettings")
	DebugNodeWindowSettings :: proc(settings: ^WindowSettings) ---
	@(link_name = "ImGui_DebugNodeWindowsList")
	DebugNodeWindowsList :: proc(windows: ^Vector_WindowPtr, label: cstring) ---
	@(link_name = "ImGui_DebugNodeWindowsListByBeginStackParent")
	DebugNodeWindowsListByBeginStackParent :: proc(windows: ^^Window, windows_size: c.int, parent_in_begin_stack: ^Window) ---
	@(link_name = "ImGui_DebugNodeViewport")
	DebugNodeViewport :: proc(viewport: ^ViewportP) ---
	@(link_name = "ImGui_DebugRenderKeyboardPreview")
	DebugRenderKeyboardPreview :: proc(draw_list: ^DrawList) ---
	@(link_name = "ImGui_DebugRenderViewportThumbnail")
	DebugRenderViewportThumbnail :: proc(draw_list: ^DrawList, viewport: ^ViewportP, bb: Rect) ---
	@(link_name = "cImFontAtlasGetBuilderForStbTruetype")
	cImFontAtlasGetBuilderForStbTruetype :: proc() -> ^FontBuilderIO ---
	@(link_name = "cImFontAtlasUpdateSourcesPointers")
	cImFontAtlasUpdateSourcesPointers :: proc(atlas: ^FontAtlas) ---
	@(link_name = "cImFontAtlasBuildInit")
	cImFontAtlasBuildInit :: proc(atlas: ^FontAtlas) ---
	@(link_name = "cImFontAtlasBuildSetupFont")
	cImFontAtlasBuildSetupFont :: proc(atlas: ^FontAtlas, font: ^Font, src: ^FontConfig, ascent: f32, descent: f32) ---
	@(link_name = "cImFontAtlasBuildPackCustomRects")
	cImFontAtlasBuildPackCustomRects :: proc(atlas: ^FontAtlas, stbrp_context_opaque: rawptr) ---
	@(link_name = "cImFontAtlasBuildFinish")
	cImFontAtlasBuildFinish :: proc(atlas: ^FontAtlas) ---
	@(link_name = "cImFontAtlasBuildRender8bppRectFromString")
	cImFontAtlasBuildRender8bppRectFromString :: proc(atlas: ^FontAtlas, x: c.int, y: c.int, w: c.int, h: c.int, in_str: cstring, in_marker_char: c.char, in_marker_pixel_value: c.uchar) ---
	@(link_name = "cImFontAtlasBuildRender32bppRectFromString")
	cImFontAtlasBuildRender32bppRectFromString :: proc(atlas: ^FontAtlas, x: c.int, y: c.int, w: c.int, h: c.int, in_str: cstring, in_marker_char: c.char, in_marker_pixel_value: c.uint) ---
	@(link_name = "cImFontAtlasBuildMultiplyCalcLookupTable")
	cImFontAtlasBuildMultiplyCalcLookupTable :: proc(out_table: ^[256]c.uchar, in_multiply_factor: f32) ---
	@(link_name = "cImFontAtlasBuildMultiplyRectAlpha8")
	cImFontAtlasBuildMultiplyRectAlpha8 :: proc(table: ^[256]c.uchar, pixels: ^c.uchar, x: c.int, y: c.int, w: c.int, h: c.int, stride: c.int) ---
	@(link_name = "cImFontAtlasBuildGetOversampleFactors")
	cImFontAtlasBuildGetOversampleFactors :: proc(src: ^FontConfig, out_oversample_h: ^c.int, out_oversample_v: ^c.int) ---
	@(link_name = "cImFontAtlasGetMouseCursorTexData")
	cImFontAtlasGetMouseCursorTexData :: proc(atlas: ^FontAtlas, cursor_type: MouseCursor, out_offset: ^Vec2, out_size: ^Vec2, out_uv_border: ^[2]Vec2, out_uv_fill: ^[2]Vec2) -> bool ---
}
